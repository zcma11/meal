...
function sendCode(phone, code, callback) {
    var ACCOUNT_SID = '8aaf070877807ed8017791d2487202c5';
    var AUTH_TOKEN = '3fabbe16249a468dbec9d9155c73c2e5';
    var Rest_URL = 'https://app.cloopen.com:8883';
    var AppID = '8aaf070877807ed8017791d2495602cb';
    //1. 准备请求url
    /*
    ...
    request({
        ...
        callback(bodys.statusCode==='000000');
        // callback(true);
    });
}
