...
const category = ['香浓甜粥', '营养咸粥', '爽口凉菜', '精选套餐', '果拼果汁', '小吃主食', '特色粥品']

function randomOneObjToMoreObj (obj, n, m) {
  let count
  if (m) {
    if (n > m) return
...
// console.log(randomOneObjToMoreObj({
//   category: 'randomArr(category, 1)',
